...
public class DatabaseHelper extends SQLiteOpenHelper{
    ...
    /**
     * If the database has not been created yet (ie. new device run) then
     * the onCreate method is run to set up and populate the databases needed
     * for the application.
     */
    @Override
    public void onCreate(SQLiteDatabase db) {
    	db.execSQL("CREATE TABLE " + DATABASE_TABLE + " (" +
    			KEY_NODE + " TEXT NOT NULL, " +
    			KEY_DESC + " TEXT NOT NULL, " +
    			KEY_XPOS + " INTEGER NOT NULL, " +
    			KEY_YPOS + " INTEGER NOT NULL, " +
    ...
    public void InsertNodes(SQLiteDatabase db) {
    	db.execSQL("INSERT INTO " + DATABASE_TABLE + " (" + KEY_NODE + ", " + KEY_DESC + ", " + KEY_XPOS + ", " + KEY_YPOS + ", " + KEY_CONN + ") VALUES " +
					...
					"('D23', 'D Block', 1688, 795, 'D310')," +
        			"('D24', 'D Block', 1710, 810, 'D314)," +
					...
					"('J04', 'J Block', 1799, 723, 'J301')," +
					"('J04', 'J Block', 1799, 723, 'J310')," +
					...
					"('J07', 'J Block', 1805, 648, 'J327')," +
					"('J07', 'J Block', 1805, 648, 'J328')," +
					...
					"('J310', 'J310', 1845, 714, 'J04')," +
        			"('J310', 'J310', 1845, 714, 'J304')," +
        			"('J301', 'J301', 1791, 765, 'J04')," +
        			"('J301', 'J301', 1791, 765, 'J304')," +
        			"('J304', 'J304', 1831, 747, 'J301')," +
        			"('J304', 'J304', 1831, 747, 'J310')," +
        			"('J328', 'J328', 1841, 651, 'J07')," +
        			"('J327', 'J327', 1799, 604, 'J07')," +
					"('D300', 'D300', 1368, 841, 'D03')," +
        			"('D301', 'D301', 1402, 843, 'D05')," +
        			"('D303', 'D303', 1473, 841, 'D07')," +
					"('D304', 'D304', 1506, 843, 'D09')," +
					"('D308', 'D308', 1608, 906, 'D11')," +
        			"('D308', 'D308', 1608, 906, 'D42')," +
        			"('D309', 'D309', 1665, 849, 'D14')," +
        			"('D309', 'D309', 1665, 849, 'D17')," +
        			"('D310', 'D310', 1695, 775, 'D23')," +
        			"('D314', 'D314', 1748, 813, 'D24')," +
        			"('D315', 'D315', 1784, 845, 'D27')," +
					"('D316', 'D316', 1811, 872, 'D28')," +
        			"('D317', 'D317', 1830, 888, 'D29')," +
        			"('D318', 'D318', 1736, 911, 'D30')," +
        			"('D319', 'D319', 1744, 933, 'D31')," +
        			"('D319', 'D319', 1744, 933, 'D33')," +
        			"('D320', 'D320', 1711, 966, 'D34')," +
        			"('D321', 'D321', 1680, 995, 'D38')," +
        			"('D321', 'D321', 1680, 995, 'D40')," +
